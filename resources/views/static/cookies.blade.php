  ...
  <div class="row">
    <div class="col-md-12 col-xs-12">
      <h2 class="page-title">Information about cookies</h2>
        ...
        <p>
        Based on the directives of the National Spanish Agency of Data Protection, next is detailed the use of the cookies in this website. With the use of this website, you are conscious and agree that we store these cookies in your computer / device / browser for the declared aims.</p>
        <p>
        Third-party cookies are those that are sent to the final machine of the user, from a host or domain that is not managed by the editor, but by another entity which treats the obtained data through the cookies. The next table explains the way we use the cookies:</p>
