...
class Institution extends Model
{
    ...
    {
        $items = \App\Models\User::where('userable_type', \App\Models\Institution::class)->inRandomOrder()->where('visible', 1)->where('image', '!=', '')->limit(18)->select('userable_id')->get()->map(function ($item, $key) {
